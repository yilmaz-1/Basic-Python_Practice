...
#  => Bir fonksiyon class yapısı içerisinde tanımlandıysa buna method denir, eğer bir class yapısı içerisinde değilse
...
# Değiştirilebilir.
# Sırasız. (3.7 versiyonundan sonra sıralı özelliğide kazanmıştır.)
# Kapsayıcı.
